...
url = "https://cn.bing.com/images/async?q={0}&first={1}&count={" \
...
def getImage(url, count):
    ...
    try:
        time.sleep(0.5)
        urllib.request.urlretrieve(url, './stand' + str(count + 1) + '.png')
...
if __name__ == '__main__':
    name = "真人直立"  # 图片关键词
    path = r'D:\develop\shixun\summer-term\intelligent-pension-system--vision\fall\spider\stand'  # 图片保存路径
    countNum = 2000  # 爬取数量
